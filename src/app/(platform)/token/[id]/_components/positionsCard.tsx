...
/**
 * PositionsCard - Displays user's open positions in a styled card.
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mb-4">
        <BriefCase className="w-6 h-6 text-[#335CFF] mr-2" aria-hidden="true" />
      ...
      <div className="flex flex-col gap-4">
        {positions.map((pos, idx) => (
          <div
            key={pos.name + idx}
            className="rounded-2xl border border-[#E9EAEC] p-4 flex flex-col gap-2 bg-white"
          >
            <div className="flex items-center justify-between">
              ...
              >
                {pos.leverage}
                {pos.leverage.startsWith("Long") ? (
                  <span className="text-green-500 text-lg ml-1">^</span>
                ) : (
                  <span className="text-red-500 text-lg ml-1">v</span>
                )}
              </span>
            </div>
            {/* Entry, Liquidated, Size, PnL */}
            {pos.entry !== null && (
              <div className="grid grid-cols-2 gap-2 mt-2">
                <div className="flex flex-col gap-1">
                  ...
                  <span className="font-bold text-lg text-[#181A20]">
                    {pos.entry} <sup className="text-xs align-super">A</sup>
                  </span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-[#B1B5C3] text-sm font-medium">
            ...
            {/* For positions without entry/liquidation/size, just show PnL */}
            {pos.entry === null && (
